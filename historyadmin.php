...
<?php
	...
	/*
	$lines3 = file('api/files/sensor4/log.txt');
    $flipped3 = array_reverse($lines3); 
    $keep3 = array_slice($flipped3,0, 5); 
    file_put_contents("api/files/sensor4/log.txt", $keep3);
	
	$lines4 = file('api/files/sensor5/log.txt');
    $flipped4 = array_reverse($lines4); 
    $keep4 = array_slice($flipped4,0, 5); 
    file_put_contents("api/files/sensor5/log.txt", $keep4);
	*/
	...
	fclose( $file2 );
	/*
	$file3 = fopen( "api/files/sensor4/log.txt", "r" );
		$index3=-1;
		$arrayValue3=[];
		$arrayHour3=[];
	...
	$file4 = fopen( "api/files/sensor5/log.txt", "r" );
		$index4=-1;
		$arrayValue4=[];
		$arrayHour4=[];
					...
					<table class="table table-bordered">
						<tbody>
                              ...
                              <tr class="textcolor">
                                ...
                                <td><?php //echo $arrayValue3[0]; ?>º</td>
                              </tr>
							  <tr class="textcolor">
                                <td><?php //echo $arrayHour3[1]; ?></td>
                                <td><?php //echo $arrayValue3[1]; ?>º</td>
                              </tr>
							  <tr class="textcolor">
                                <td><?php //echo $arrayHour3[2]; ?></td>
                                <td><?php //echo $arrayValue3[2]; ?>º</td>
                              </tr>
							  <tr class="textcolor">
                                <td><?php //echo $arrayHour3[3]; ?></td>
                                <td><?php //echo $arrayValue3[3]; ?>º</td>
                              </tr>
							  <tr class="textcolor">
                                <td><?php //echo $arrayHour3[4]; ?></td>
                                <td><?php //echo $arrayValue3[4]; ?>º</td>
                              </tr>
						</tbody>
					</table>
					</div>
					...
					<table class="table table-bordered">
						<tbody>
                              ...
                              <tr class="textcolor">
                                ...
                                <td><?php //echo $arrayValue4[0]; ?>%</td>
                              </tr>
							  <tr class="textcolor">
                                <td><?php //echo $arrayHour4[1]; ?></td>
                                <td><?php //echo $arrayValue4[1]; ?>%</td>
                              </tr>
							  <tr class="textcolor">
                                <td><?php //echo $arrayHour4[2]; ?></td>
                                <td><?php //echo $arrayValue4[2]; ?>%</td>
                              </tr>
							  <tr class="textcolor">
                                <td><?php //echo $arrayHour4[3]; ?></td>
                                <td><?php //echo $arrayValue4[3]; ?>%</td>
                              </tr>
							  <tr class="textcolor">
                                <td><?php //echo $arrayHour4[4]; ?></td>
                                <td><?php //echo $arrayValue4[4]; ?>%</td>
                              </tr>
						</tbody>
					</table>
					</div>
